...
public class InterfaceConfigServlet extends HttpServlet
{
    ...
    public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException
    {
        try
        {
            ...
            config.put( "DISABLE_DOMINANT_SPEAKER_INDICATOR",    JiveGlobals.getBooleanProperty( "org.jitsi.videobridge.ofmeet.disable.dominant.indicator",    false               ) );
            ...
            //config.put( "MAXIMUM_ZOOMING_COEFFICIENT",           JiveGlobals.getProperty(     "org.jitsi.videobridge.ofmeet.max.zoom.coefficient",          1.3                 ) );
            config.put( "VERTICAL_FILMSTRIP",                    JiveGlobals.getBooleanProperty( "org.jitsi.videobridge.ofmeet.vertical.filmstrip",            false               ) );
            config.put( "CLOSE_PAGE_GUEST_HINT",                 JiveGlobals.getBooleanProperty( "org.jitsi.videobridge.ofmeet.close.page.guest",              false               ) );
